    ...
    const columns: Array<{
        ...
        { id: 'contact', label: 'Contacto', numeric: true },
        { id: 'associatedLoan', label: 'NLoan', numeric: false },
        { id: 'birthDate', label: 'Data de Nascimento', numeric: false },
        { id: 'document', label: 'ID', numeric: false },
        { id: 'idNumber', label: 'Número de ID', numeric: false },
        { id: 'totalLoans', label: 'Total Loans', numeric: true },
    ];
    ...
    function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
        ...
        return (
            ...
            >
                    ...
                    <Tooltip title="Adicionar Novo Cliente" onClick={() => router.push('/customers/add')}>
                                ...
                                {visibleRows.map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left" style={{ width: '100px' }}>{row?.phoneNumber}</TableCell>
                                            <TableCell align="left" style={{ width: '120px' }}>{row?.associatedLoan || 'N/A'}</TableCell>
                                            <TableCell align="left" style={{ width: '180px' }}>
                                                {row?.idDocument?.birthDate ? formatDate(row?.idDocument?.birthDate) : 'dd/MM/yyyy'}
                                            </TableCell>
                                            <TableCell style={{ width: '200px' }} align="left">{row?.idDocument?.documentType?.description}</TableCell>
                                            <TableCell style={{ width: '150px' }} align="left">{row?.idDocument?.number}</TableCell>
                                            <TableCell style={{ width: '150px' }} align="left">{row?.totalLoans}</TableCell>
                                        </TableRow>
                                    );
                                })}
